...
from directory.models import Team
...
class Task(models.Model):
    ...
    # Status derived from the Status enum
    status = models.CharField(
        verbose_name="Status",
    ...
    # Date which the task starts. Defaults to today
    start_date = models.DateField(
        verbose_name="Start Date",
        default=get_default_start_date
    )

    # Date which the task ends. Defaults to 30 days from today
    due_date = models.DateField(
        verbose_name="End Date",
        default=get_default_end_date
    )

    # File attachments. Points to Amazon S3 Bucket
